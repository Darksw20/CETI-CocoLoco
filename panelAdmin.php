          ...
          <div class="card-body">
            <form action="src/transacciones.php" method="post" id="transaccion">
              <div class="form-row">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="buscarPGanancia" name="buscarPGanancia" onkeyup="verGanciasPProducto()" placeholder="HP-1ZW00LA">
                </div>
              </div>
            </form>
            <div class="table-responsive" style="padding-top: 2rem;">
      ...
      <div class="row">
        <div class="container-fluid">
          <?php
            if (!empty($_GET['msg'])) {
              echo "     
                  <div class='alert alert-success position-absolute pos' role='alert'>".
                    $_GET['msg']
                  ."</div>
              "; 
            }
