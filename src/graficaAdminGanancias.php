<?php 
    ...
    $Dato1=mysqli_query($con,"SELECT IFNULL(SUM(Amount),'0') FROM Transaction AS A INNER JOIN Stocktaking AS B ON A.Stocktaking_ID=B.ID WHERE A.Date BETWEEN '$fecha7m1' AND '$fecha7m2'");
    ...
    $Dato2=mysqli_query($con,"SELECT IFNULL(SUM(Amount),'0') FROM Transaction AS A INNER JOIN Stocktaking AS B ON A.Stocktaking_ID=B.ID WHERE A.Date BETWEEN '$fecha6m1' AND '$fecha6m2'");
    ...
    $Dato3=mysqli_query($con,"SELECT IFNULL(SUM(Amount),'0') FROM Transaction AS A INNER JOIN Stocktaking AS B ON A.Stocktaking_ID=B.ID WHERE A.Date BETWEEN '$fecha5m1' AND '$fecha5m2'");
    ...
    $Dato4=mysqli_query($con,"SELECT IFNULL(SUM(Amount),'0') FROM Transaction AS A INNER JOIN Stocktaking AS B ON A.Stocktaking_ID=B.ID WHERE A.Date BETWEEN '$fecha4m1' AND '$fecha4m2'");
    ...
    $Dato5=mysqli_query($con,"SELECT IFNULL(SUM(Amount),'0') FROM Transaction AS A INNER JOIN Stocktaking AS B ON A.Stocktaking_ID=B.ID WHERE A.Date BETWEEN '$fecha3m1' AND '$fecha3m2'");
    ...
    $Dato6=mysqli_query($con,"SELECT IFNULL(SUM(Amount),'0') FROM Transaction AS A INNER JOIN Stocktaking AS B ON A.Stocktaking_ID=B.ID WHERE A.Date BETWEEN '$fecha2m1' AND '$fecha2m2'");
    //echo "2 dias:".$fecha2m."|".$fecha2m1."|".$fecha2m2."<br>";//a la fecha hoy resto 6 dias
    $fecha1m = date("Y-m-d");
    $fecha1m1 = $fecha1m." 00:00:00";
    $fecha1m2 = $fecha1m." 23:59:59";
    $Dato7=mysqli_query($con,"SELECT IFNULL(SUM(Amount),'0') FROM Transaction AS A INNER JOIN Stocktaking AS B ON A.Stocktaking_ID=B.ID WHERE A.Date BETWEEN '$fecha1m1' AND '$fecha1m2'");
